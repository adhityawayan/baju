            ...
            <div class="portlet-body">
                <form class="form-horizontal" method="post" action="<?=$link_act?>" role="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="name" placeholder="Nama Operasional..">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 col-sm-offset-1 control-label">Biaya</label>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="cost" placeholder="Biaya Operasional..">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 col-sm-offset-1 control-label">Keterangan</label>
                        <div class="col-sm-5">
                            <textarea rows="3" class="form-control" name="deskripsi" placeholder="Keterangan Operasional.."></textarea>
                        </div>
                    </div>
                    <div class="form-group">
